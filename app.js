...
const startingLake=() => {
    ...
    //prompt
    let chooseItems = prompt(`'You look into your back pack, choose what you will eat for lunch'${items}`)
    //if, else if statement
    if (chooseItems =="River fish" || chooseItems== "river fish," || chooseItems== "river fish" || chooseItems== "River Fish,")
